    ...
    <ContentContainer>
      ...
      <div className="accordion">
        ...
        <p>
          ...
          doesn&apos;t work well or efficiently, I like to find out how to make
          it better, and it shows with the changes I&apos;ve made while at
          Purdue:
        </p>
        <ul>
        ...
        <p>
          ...
          program gave me a great foundation, I felt I was missing out on
          applying it. I looked around for something a bit more practical and
          decided to take an introduction to web development, which was part of
          the Computer Graphics Technology (CGT) program.
        </p>
        <p>
        ...
        <p>
          ...
          their own way, front-end development was where I found a home. It is
          the perfect combination of <mark>creativity</mark> and{" "}
          <mark>logic</mark> while also having a <mark>visually-rewarding</mark>{" "}
