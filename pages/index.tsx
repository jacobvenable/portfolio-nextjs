          ...
          <div className="accordion">
            ...
            >
              ...
              <p>
                ...
                Colorado. I have been working remotely for Purdue&apos;s Office
                of Marketing and Media, which is based in Indiana, since August
                2017.
              </p>
              <button
                aria-level={3}
              ...
              <p>
                ...
                out how to make it better, and it shows with the changes
              ...
              <p>
                ...
                that I&apos;ve wanted to have a career in development. To move
                in that direction, I applied to and was accepted into Purdue
              ...
              <p>
                ...
                was missing out on applying it. I looked around for something a
                bit more practical and decided to take an introduction to web
                development, which was part of the Computer Graphics Technology
                (CGT) program.
              </p>
              <p>
                Long story short, I fell in love with web development, switched
                to the CGT program, and the rest is history.
              </p>
              <button
                aria-level={3}
                className="accordion__button"
              ...
              <p>
                ...
                <mark>creativity</mark> and <mark>logic</mark> while also having
                a <mark>visually-rewarding</mark> product as the end-result.
              </p>
              <button
                aria-level={3}
                className="accordion__button"
              ...
              <p>
                I would definitely fight a horse-sized duck. Battling a hundred
                of anything would be tiring.
              </p>
              {/* </Accordions> */}
            </Disclosure>
          </div>
