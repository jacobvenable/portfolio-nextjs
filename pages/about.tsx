  ...
  return (
    <ContentContainer>
      ...
      <Typography>
        ...
        make my living through some kind of programming. After being exposed to
        multiple avenues that could scratch that itch, I found my love of the
        web where my work could reach millions in an instant.
      </Typography>
      <Grid.Container>
        <Grid.Item tablet={50}>
          <Typography>
